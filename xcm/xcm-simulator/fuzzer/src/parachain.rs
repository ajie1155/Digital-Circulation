...
use digital_circulation_core_primitives::BlockNumber as RelayBlockNumber;
use digital_circulation_dcchain::primitives::{
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic,
	{
		...
		DigitalCirculationXcm: pallet_xcm::{Pallet, Call, Event<T>, Origin},
	}
);
